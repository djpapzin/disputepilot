...
curl -X POST http://127.0.0.1:8000/telegram/updates -H 'Content-Type: application/json' -d '{"callback_query":{"id":"cb-1","from":{"id":123456},"data":"disputepilot:DP-DEBT-001:1:approve_draft"}}'
