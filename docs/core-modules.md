...
| Telegram approval cards | Converts recommended actions into reviewable cards. | Case ID, priority, deadline, current approval state, card revision, draft outline. | State-aware Approve/Edit/Snooze/Mark done previews. | Do not include sensitive proof or private identifiers in card previews. |
